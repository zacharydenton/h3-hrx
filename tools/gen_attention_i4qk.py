...
""")
# --- the key scale one tile ahead: the per-tile global load of ks sat on the path to the scores (ablation: 5% of the
# loop); it is loaded for the next tile at the end of the iteration and carried (measured 1.036x at 15427 rows)
