...
def build(tokens: int) -> Path:
    out = ROOT / "build/kernels_vae" / f"T{tokens}"
    ...
    attn = "h3." + attn_stem
    specs = [
        ("prepare_norm_i4", "h3_prepare_norm_i4", "prepare_norm_i4", {"h3.prepare_norm_i4.width": HIDDEN, "h3.prepare_norm_i4.lanes": 256, "h3.prepare_norm_i4.eps": 1e-5, "h3.prepare_norm_i4.classes": 1}),
        ("prepare_plain_i4", "h3_prepare_plain_i4", "prepare_attn_i4", {"h3.prepare_plain_i4.width": INNER, "h3.prepare_plain_i4.lanes": 256}),
        ("prepare_plain_i4", "h3_prepare_plain_i4", "prepare_down_i4", {"h3.prepare_plain_i4.width": FFN, "h3.prepare_plain_i4.lanes": 256}),
        ("gemm_i4_256b", "h3_gemm_i4_256b", "gemm_qkv", {"h3.gemm_i4_256b.k_size": HIDDEN, "h3.gemm_i4_256b.n_size": 3 * INNER, "h3.gemm_i4_256b.m_group": m_group}),
        ("gemm_i4_swiglu_256b_gs", "h3_gemm_i4_swiglu_256b_gs", "gemm_gu", {"h3.gemm_i4_swiglu_256b_gs.k_size": HIDDEN, "h3.gemm_i4_swiglu_256b_gs.n_size": 2 * FFN, "h3.gemm_i4_swiglu_256b_gs.m_group": m_group}),
        ("gemm_i4_resid_256b", "h3_gemm_i4_resid_256b", "gemm_out", {"h3.gemm_i4_resid_256b.k_size": INNER, "h3.gemm_i4_resid_256b.n_size": HIDDEN, "h3.gemm_i4_resid_256b.m_group": m_group, "h3.gemm_i4_resid_256b.classes": 1}),
        ("gemm_i4_resid_256b", "h3_gemm_i4_resid_256b", "gemm_down", {"h3.gemm_i4_resid_256b.k_size": FFN, "h3.gemm_i4_resid_256b.n_size": HIDDEN, "h3.gemm_i4_resid_256b.m_group": m_group, "h3.gemm_i4_resid_256b.classes": 1}),
        ("rope64_qknorm_f16", "h3_rope64_qknorm_f16", "rope_qknorm", {"h3.rope64_qknorm_f16.row_stride": 3 * INNER, "h3.rope64_qknorm_f16.heads": HEADS, "h3.rope64_qknorm_f16.k_offset": INNER, "h3.rope64_qknorm_f16.eps": 1e-5}),
