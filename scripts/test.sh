...
step "decoder attention (head 64, 32-key staging)" env -u LD_LIBRARY_PATH ATTN_D=64 ATTN=attention_mha64t32_lds_f16_wmma "$REF_PY" tests/test_attention.py --tokens 13 32 40 64 65 96 517 1797
step "decoder attention (head-major QKV)" env -u LD_LIBRARY_PATH ATTN_D=64 ATTN=attention_mha64hm32_lds_f16_wmma "$REF_PY" tests/test_attention.py --tokens 13 32 40 64 65 96 517 1797
