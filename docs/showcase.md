...
The whale and desert scenes use text only; the iceberg animates a generated first frame.

Each clip is 864×480, 124 frames at 24 fps (5.17 seconds), with 20 evaluations of
`res_multistep`, with no frame interpolation or upscaling.
