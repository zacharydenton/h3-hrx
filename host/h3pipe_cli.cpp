...
int main(int argc, char **argv) {
    ...
    h3pipe_params p = {atoi(arg(argc, argv, "--height", "480")), atoi(arg(argc, argv, "--width", "864")), atoi(arg(argc, argv, "--frames", "124")), atoi(arg(argc, argv, "--steps", "50")), (uint64_t)atoll(arg(argc, argv, "--seed", "0")), 0.0f, 0.0f};
